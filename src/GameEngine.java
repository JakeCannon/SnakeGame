...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
	...
	public void setupWindow(int width, int height) {
		...
		mFrame.setLocationRelativeTo(null); // Opens nearer to screen center
		mFrame.setTitle("Window");
		mFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		mFrame.add(mPanel);
		mFrame.setVisible(true);
		mFrame.setResizable(false); // prevent window from being resized
	...
	protected class GameTimer extends Timer {
		...
		public void setFramerate(int framerate) {
			...
			// This controls the speed of the game (how fast snake moves, etc)
			int delay = 6000 / framerate;
			setInitialDelay(0);
			setDelay(delay);
		}
	...
	Color grey = new Color(100, 100, 100); // added grey to color list
	Color transparentBlack = new Color(0, 0, 0, 200); // added transparent black
